...
def test_constructor():
    ...
    try:
        ...
        # Test All Reduce
        local_rank = rank % 4
        tensor, tensor_id = comm_wrapper.allocate_tensor(4096, torch.bfloat16, torch.device(f"cuda:{local_rank}"))
        tensor.fill_(1)
        ...
        comm_wrapper.set_kernel_params(32, 512, num_chunks)
        ...
        # Count the non-zero elements in the tensor
